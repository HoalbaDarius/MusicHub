...
const concertEvents: Event[] = [
  {
    ...
    description:
      "Experience Logic live with his iconic album performed in full, featuring special guests and unreleased tracks.",
    imageUrl:
      "https://upload.wikimedia.org/wikipedia/en/thumb/9/9c/Logic_-_Under_Pressure_%28Deluxe_Edition%29.jpg/220px-Logic_-_Under_Pressure_%28Deluxe_Edition%29.jpg",
  ...
  },
  {
    ...
    description:
      "The Weeknd brings his chart-topping hits to life with an immersive audiovisual experience you won't forget.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Billie Eilish returns with her biggest world tour yet, featuring songs from her entire discography.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Join Marko Glass for an unforgettable night of trap music with guest performers from the underground scene.",
    imageUrl:
      "https://images.genius.com/199959a75bd7b76d5c81e92018402658.1000x1000x1.png",
  ...
  },
  {
    ...
    description:
      "BTS brings their electrifying performances to fans worldwide with this spectacular concert experience.",
    imageUrl:
      "https://i1.wp.com/stephanieeffevottu.com/wp-content/uploads/2023/06/20230609_100516.jpg?fit=1200%2C800&ssl=1",
  ...
  },
  {
    ...
    description:
      "Prepare for an intense night with Slipknot as they deliver their signature sound and theatrical performance.",
    imageUrl:
      "https://i8.amplience.net/i/naras/slipknot_MI0005599206-MN0000750742",
...
const Events: React.FC = () => {
  ...
  const handleTouchMove = (e: TouchEvent<HTMLDivElement>) => {
    ...
    if (
      ...
      (currentIndex >= maxSlideIndex && translate < 0)
    ) {
          ...
          <div
            ...
            style={{
              transform: `translateX(${
                -currentIndex * (100 / eventsPerPage)
              }%)`,
          ...
          {Array.from({ length: totalIndicators }).map((_, index) => (
            <div
              ...
              className={`carousel-indicator ${
                getActiveIndicator(index) ? "active" : ""
              }`}
